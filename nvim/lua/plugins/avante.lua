return {
  {
    ...
    opts = {
      ...
      ---2. first_provider: The firs:t provider to generate response. Default to "openai".
      ...
      behaviour = {
        ...
        minimize_diff = true, -- Whether t:qo remove unchanged lines when applying a code block
      },
      mappings = {
